              ...
              <CardContent className="p-10 relative">
                ...
                <div className="text-center mb-10 relative">
                  ...
                  <p className="text-muted-foreground text-lg">
                    Para iniciar el proyecto, realiza el pago del 50% del valor total
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 relative">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-muted-foreground">
                      <p><span className="font-medium text-foreground">EPRAI EVENTOS PRIME AI S.A.S.</span></p>
                      <p>Produbanco - CUENTA PRO PYME</p>
                      <p>#27059118461</p>
                      <p>RUC: 0993401502001</p>
                    </div>
                  </motion.div>
                </div>
              </CardContent>
